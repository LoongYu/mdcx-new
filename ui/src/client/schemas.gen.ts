...
export const WebsiteSchema = {
    type: 'string',
    enum: ['airav_cc', 'avsex', 'avsox', 'cableav', 'cnmdb', 'dmm', 'fantastica', 'fc2', 'fc2hub', 'fc2ppvdb', 'freejavbt', 'getchu', 'giga', 'hdouban', 'hscangku', 'iqqtv', 'jav321', 'javbus', 'javday', 'javdb', 'javlibrary', 'kin8', 'lulubar', 'madouqu', 'mdtv', 'mgstage', '7mmtv', 'mywife', 'theporndb', 'xcity'],
    title: 'Website',
    showNames: ['AIRAV_CC', 'AVSEX', 'AVSOX', 'CABLEAV', 'CNMDB', 'DMM', 'FANTASTICA', 'FC2', 'FC2HUB', 'FC2PPVDB', 'FREEJAVBT', 'GETCHU', 'GIGA', 'HDOUBAN', 'HSCANGKU', 'IQQTV', 'JAV321', 'JAVBUS', 'JAVDAY', 'JAVDB', 'JAVLIBRARY', 'KIN8', 'LULUBAR', 'MADOUQU', 'MDTV', 'MGSTAGE', 'MMTV', 'MYWIFE', 'THEPORNDB', 'XCITY']
} as const;
