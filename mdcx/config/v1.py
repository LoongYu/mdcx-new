...
class ConfigV1:
    ...
    website_youma: str = (
        r"iqqtv,javbus,freejavbt,jav321,dmm,javlibrary,jable,javfree,7mmtv,hdouban,javdb,lulubar,xcity"
    )
    ...
    title_website: str = r"theporndb,mgstage,dmm,javbus,jav321,javlibrary,javfree"
    title_zh_website: str = r"iqqtv,lulubar"
    title_website_exclude: str = r""
    outline_website: str = r"theporndb,dmm,jav321,javfree"
    outline_zh_website: str = r"iqqtv,lulubar"
    outline_website_exclude: str = r"javbus,javdb,javlibrary,freejavbt,hdouban"
    actor_website: str = r"theporndb,javbus,javlibrary,javdb,javfree"
    actor_website_exclude: str = r""
    thumb_website: str = r"theporndb,javbus,javfree"
    thumb_website_exclude: str = r"javdb"
    poster_website: str = r"theporndb,javbus,javfree"
    poster_website_exclude: str = r"fc2hub,iqqtv,7mmtv,javlibrary,lulubar"
    extrafanart_website: str = r"javbus,freejavbt,javfree"
    extrafanart_website_exclude: str = r"iqqtv,javlibrary,lulubar"
    trailer_website: str = r"freejavbt,mgstage,dmm"
    trailer_website_exclude: str = r"7mmtv,lulubar"
    tag_website: str = r"javbus,freejavbt,javfree"
    tag_website_exclude: str = r""
    release_website: str = r"javbus,freejavbt,7mmtv,javfree"
    release_website_exclude: str = r"fc2hub"
    runtime_website: str = r"javbus,freejavbt,javfree"
    runtime_website_exclude: str = r"fc2,fc2hub,lulubar"
    score_website: str = r"jav321,javlibrary,javdb"
    score_website_exclude: str = r"7mmtv,fc2,fc2hub,iqqtv,javbus,xcity,lulubar"
    director_website: str = r"javbus,freejavbt,javfree"
    director_website_exclude: str = r"fc2,fc2hub,iqqtv,jav321,mgstage,lulubar"
    series_website: str = r"javbus,freejavbt"
    series_website_exclude: str = r"iqqtv,7mmtv,javlibrary,lulubar"
    studio_website: str = r"javbus,freejavbt,javfree"
    studio_website_exclude: str = r""
    publisher_website: str = r"javbus,javfree"
    publisher_website_exclude: str = r"iqqtv,lulubar"
    wanted_website: str = r"javlibrary,javdb,javfree"
